...
function SchemePreview({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: `1px solid ${scheme.border}` }}>
        <div className="flex items-center gap-3">
          <div className="h-4 w-4 rounded-full" style={{ backgroundColor: scheme.primary }} />
          <span className="font-display text-lg tracking-wider text-white">{scheme.name}</span>
        </div>
        <span
      ...
      <div className="p-6">
        ...
        >
          <span className="font-display text-sm tracking-wider text-white">VEILPAY</span>
          <div className="flex items-center gap-3">
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="font-display mt-1 text-xl tracking-wider text-white">{card.value}</p>
                </div>
        ...
        >
          <div className="px-4 py-2" style={{ borderBottom: `1px solid ${scheme.border}` }}>
            <span className="font-display text-xs tracking-wider text-white">EMPLOYEES</span>
          </div>
        ...
        <div className="mt-4 flex gap-3">
          ...
          <button
            ...
            style={{ border: `1px solid ${scheme.border}`, backgroundColor: "transparent" }}
          >
            Generate Proof
          </button>
        </div>
        ...
        >
          ...
          <div className="flex items-start justify-between">
            <div>
              <span className="text-[10px] uppercase tracking-wider" style={{ color: `${scheme.primary}99` }}>
                ZK Credential
              </span>
              <p className="font-display mt-0.5 text-sm tracking-wider text-white">INCOME PROOF</p>
            </div>
            <span className="text-lg">🔐</span>
          </div>
          <div className="mt-3 rounded-lg p-2" style={{ backgroundColor: "rgba(255,255,255,0.05)" }}>
            <p className="text-[10px]" style={{ color: "rgba(255,255,255,0.4)" }}>Statement</p>
            <p className="text-xs font-medium text-white">Annual income exceeds $50,000</p>
          </div>
        ...
        >
          ...
          <p className="font-display mt-1 text-sm tracking-wider" style={{ color: scheme.primary }}>
            VERIFIED
          </p>
        ...
        <div className="mt-4 flex items-center gap-2">
          <div className="h-6 w-6 rounded-full" style={{ backgroundColor: scheme.primary }} title="Primary" />
          <div className="h-6 w-6 rounded-full" style={{ backgroundColor: scheme.primaryLight }} title="Primary Light" />
          <div
            className="h-6 w-6 rounded-full"
            style={{ backgroundColor: scheme.bg, border: `1px solid ${scheme.border}` }}
            title="Background"
          />
          <div className="ml-auto flex gap-2 font-mono text-[10px]" style={{ color: "rgba(255,255,255,0.3)" }}>
    ...
    <div className="min-h-screen bg-[#050505] px-6 py-12">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-3 text-center text-white/50">
          Click any scheme to focus. Each preview shows the full VeilPay UI palette.
        </p>
